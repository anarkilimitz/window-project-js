...
const changeModalState = state => {
  ...
  (0,_checkNumInputs__WEBPACK_IMPORTED_MODULE_0__["default"])('#width'); // валидация инпута
  (0,_checkNumInputs__WEBPACK_IMPORTED_MODULE_0__["default"])('#height'); // валидация инпута
...
const forms = state => {
  ...
  (0,_checkNumInputs__WEBPACK_IMPORTED_MODULE_0__["default"])('input[name="user_phone"]'); // валидация инпутов на число
